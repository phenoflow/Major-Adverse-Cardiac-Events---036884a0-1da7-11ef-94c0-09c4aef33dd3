...
(async () => {
  ...
  await fs.writeFile("major-adverse-cardiac-events-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("major-adverse-cardiac-events-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
